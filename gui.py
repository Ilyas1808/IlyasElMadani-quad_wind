...
class GUI():
    ...
    def __init__(self, quads):
        ...
        self.ax.set_xlim3d([-100.0, 600.0])
        self.ax.set_xlabel('X')
        self.ax.set_ylim3d([-100.0, 600.0])
        ...
        self.zoom_button = plt.axes([0.8, 0.9, 0.1, 0.1])
        self.zoom_button = plt.Button(self.zoom_button, 'Zoom')
        self.zoom_button.on_clicked(self.zoom_in)
